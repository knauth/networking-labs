...
if __name__ == '__main__':
    # Originally I built this to be launched via command line with either
    # "server" or "client" as an arg, but this makes it fit the guidelines
    con = ConnectionHandler('server')
